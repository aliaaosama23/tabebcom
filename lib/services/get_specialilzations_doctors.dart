...
Future<List<Doctor>> getDoctorsBySpeciality(http.Client client,
  ...
  print('lat is $lat');
  print('long is $long');
   var url='https://mcare.careofme.net/api/Doctor/GetDoctors?DoctorSpeciality=$speciality&Branch_ID=null&ClinicDept_Code=null&lat=$lat&long=$long&DistanceKilos=50';
